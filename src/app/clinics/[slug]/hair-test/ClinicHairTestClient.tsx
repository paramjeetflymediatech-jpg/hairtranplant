                  ...
                  {step === 4 && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                      <div className="space-y-3 text-center">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block font-sans">Does hair thinning run in your family? <span className="text-red-500">*</span></label>
