...
import ClinicPrivacyClient from './ClinicPrivacyClient';

interface PageProps {
  params: Promise<{ slug: string }>;
}

export default async function ClinicPrivacyPage({ params }: PageProps) {
  ...
  return <ClinicPrivacyClient clinic={serializedClinic} />;
}
