...
import ClinicLoginClient from './ClinicLoginClient';

interface PageProps {
  params: Promise<{ slug: string }>;
}

export default async function ClinicLoginPage({ params }: PageProps) {
  ...
  return <ClinicLoginClient clinic={serializedClinic} />;
}
