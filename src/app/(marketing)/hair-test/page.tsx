        ...
        <div className="max-w-6xl w-full space-y-8 z-10">
          ...
          <div className="text-center space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900 border border-slate-850 text-xs font-semibold tracking-wide">
              ...
              <span className="text-teal-400">Interactive Diagnosis Flow</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
              Free AI Hair & Lifestyle Test
            </h1>
            <p className="text-slate-400 max-w-md mx-auto text-xs md:text-sm font-medium leading-relaxed">
              Answer basic questions about your routines, diet, and genetics. Upload optional photos to receive a clinical assessment.
            </p>
          </div>
          ...
          {result ? (
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 md:p-10 shadow-[0_0_50px_rgba(255,255,255,0.03)] space-y-8 animate-in fade-in zoom-in-95 duration-500">
              ...
              <div className="text-center space-y-2 pb-6 border-b border-slate-800/60">
                ...
                <p className="text-sm text-white font-medium">Auto-generated diagnostic report for lead review</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-slate-950/40 border border-slate-800/60 rounded-2xl p-6 space-y-3.5 text-center relative overflow-hidden group hover:border-slate-700 transition-colors">
                  ...
                  <span className="text-xs font-bold text-white uppercase tracking-wider block font-sans">Alopecia Stage</span>
              ...
              <div className="p-6 bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-2xl text-xs md:text-sm text-amber-300 font-semibold leading-relaxed text-center shadow-inner">
                ⚠️ Automated estimate based on provided details. A clinic consultant has received your results and will reach out to you shortly at {phone || email} to review your clinical timeline.
              </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {[
                            ...
                            <button
                              ...
                              style={thinningArea === item.id ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                            >
                              {item.label}
                            </button>
                          ))}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {[
                            ...
                            <button
                              ...
                              style={fallSpeed === item.id ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                            >
                              {item.label}
                            </button>
                          ))}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {['Less than 6 hours', '6-8 hours', '8+ hours'].map((item) => (
                            <button
                              ...
                              style={sleep === item ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                            >
                              {item}
                            </button>
                          ))}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {['High', 'Moderate', 'Low'].map((item) => (
                            <button
                              ...
                              style={stress === item ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                            >
                              {item}
                            </button>
                          ))}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {['Vegetarian', 'Non-Vegetarian', 'Vegan'].map((item) => (
                            <button
                              ...
                              style={diet === item ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                            >
                              {item}
                            </button>
                          ))}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        {['Yes', 'No', 'Uncertain'].map((item) => (
                          <button
                            ...
                            style={familyHistory === item ? { borderColor: '#0d9488', boxShadow: `0 0 15px rgba(13,148,136,0.25)`, color: '#0d9488' } : {}}
                          >
                            {item}
                          </button>
                        ))}
