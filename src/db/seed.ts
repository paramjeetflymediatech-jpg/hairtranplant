...
export async function seedDatabase() {
  ...
  const clinicApex = await Clinic.create({
    ...
    featureImage: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=800&auto=format&fit=crop&q=80',
    themeColor: '#0d9488',
  ...
  const clinicASG = await Clinic.create({
    ...
    featureImage: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&auto=format&fit=crop&q=80',
    themeColor: '#f59e0b',
  ...
  const clinicHarley = await Clinic.create({
    ...
    featureImage: 'https://images.unsplash.com/photo-1584824486509-112e4181ff6b?w=800&auto=format&fit=crop&q=80',
    themeColor: '#eab308',
